...
if (isset($_POST['register'])) {
	$resets = "UPDATE db.students SET entered='NO', exitted='NO', present='NO'";
	mysqli_query($conn, $resets);
}
					...
					<div class="card mb-3">
						...
						<div class="card-body">
							<div class="table-responsive">
								<table class="table table-bordered" id="refresh" width="100%" cellspacing="0">
									<thead>
										<tr>
											<th>Name</th>
											<th>Class</th>
									...
									<tbody>
										<?php
	$result = mysqli_query($conn,'SELECT * FROM students WHERE present="YES"');    
    while($row = mysqli_fetch_array($result))
    {      
        echo '<tr><td>' . $row['studentname'] . "</td><td>" . $row['classname'] . "</td><td>" . $row['present'] . "</td></tr>";
        echo "
		"; 
    } 
?>
								...
								<div class="form-group modal-footer">
									<button type="submit" class="btn btn-block btn-primary col-md-3" name="register">Reset</button>
								</div>
							</div>
						</div>
